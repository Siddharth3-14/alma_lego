...
attenas_inp = "000000000100010010000010000000000001001001000"
    ...
    try:
        ...
        if PLOT:
            try:               
                ...
                p2.text(-0.1,0.5,r"$\times$",ha='center', va='center',fontsize = 25, transform=p2.transAxes)
                ...
                if not singledish:    
                    ...
                    p5.set_title("Beam of the ALMA",fontsize = 15)                    
                    ...
                    p5.text(-0.1,0.5,r"$\times$",ha='center', va='center',fontsize = 25, transform=p2.transAxes)
                    p5.axes.get_xaxis().set_visible(False)
                    p5.axes.get_yaxis().set_visible(False)
