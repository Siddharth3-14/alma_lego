...
# When NoSerial is true, no port will be opened and a dummy string can be used.
# The dummy string is defined later in the code.
# -----------------------------------------------------------------------------
NoSerial = True

# Define WebCAM use, False or True
# --------------------------------
webcam = False

# Make sure we are telling the console what is going on
# True or False
# -----------------------------------------------------
verbose = True


# screenZoom controls the size of the plot window.
# 0<screenZoom<=1
# ------------------------------------------------
screenZoom = 0.7
...
def waitforserialchange(ser, bitdict, ant_dict, npadarray=45, verbose=False):
    ...
    while not validhaselection:
        ...
        # Setup for testrun without serial input.
        # linein2 contains buttons to control hourangle and input selections. 7 bits.
        # see definition of bitdict for description of each bit.
        # ------------------------------------------------------------------------------
        # if (not NoSerial) :
        #     linein2  = "1000001" #serialinput[npadarray:]
        # else:
